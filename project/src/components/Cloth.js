        ...
        <div className="bg-white cursor-pointer mx-auto flex flex-wrap mb-10 hover:scale-105 transition 
            ...
            <div className="p-7 flex flex-col justify-center items-center font-merriweather">
                ...
                <div className="font-medium text-[#333333] text-md mb-5">${item.price}</div>
                {
                    ...
                    (
                        <button onClick={removeFromCart} className="bg-[#c62828] transition ease-in duration-200 hover:bg-[#e53935] flex items-center gap-x-2 uppercase font-semibold text-white pl-4 pr-4 pt-3 pb-3 rounded-md ">
                            <FaShoppingCart />
